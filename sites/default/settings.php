...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'maita_baobab_db',
      'username' => 'maita_userb',
      'password' => 'zNnL5sm#]p&5',
      'host' => 'localhost',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
 ...
 *
 */
$drupal_hash_salt = 'ZPnusmBJ4CcES8fQTyWkisgJdnjWbHHJjypdCvjJOrM';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_Baobab_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_Baobab_dd.inc';
}
// </DDSETTINGS>
